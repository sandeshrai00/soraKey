  ...
  Column {
    ...
    BorderSurface {
      ...
      QQC.Popup {
        ...
        implicitHeight: Math.max(Style.spacing.searchablePopupMinHeight,
                                 Math.min(resultList.contentHeight + Style.space(50) + confirmH + toastH,
                                          Style.spacing.popupRowHeight * 6 + 5 * Style.spacing.labelGap + Style.space(50) + confirmH + toastH))
        ...
        contentItem: Column {
            ...
            ListView {
              ...
              delegate: Rectangle {
                  ...
                  Column {
                    ...
                    Row {
                      ...
                      Text {
                        ...
                        color: index === resultList.currentIndex ? Style.hoverStateColor(root.foreground, Color.accent) : root.foreground
                        font.family: Style.font.family
                        font.pixelSize: Style.font.body
                        elide: Text.ElideRight
                      ...
                      Text {
                        ...
                        text: "(pre)"
                        color: index === resultList.currentIndex ? Style.hoverStateColor(root.foreground, Color.accent) : Qt.darker(root.foreground, 1.5)
                        font.family: Style.font.family
                        font.pixelSize: Style.font.caption
                        anchors.verticalCenter: parent.verticalCenter
                      }
                ...
                Text {
                  ...
                  text: "✕"
                  color: index === resultList.currentIndex ? Style.hoverStateColor(root.foreground, Color.accent) : Qt.darker(root.foreground, 1.3)
                  font.family: Style.font.family
                  font.pixelSize: Style.font.body
          ...
          Column {
            ...
            width: parent.width
            spacing: Style.spacing.xs
            property string pretty: Model.prettyPackName(String(root.deleteConfirmId))
